            ...
            while ((line = br.readLine()) != null) {
                ...
                if (args[0].equals(auth.getNickname())) {
                	switch (args.length) {
                		...
                		case 11: {
                			newAuth = new PlayerAuth(args[0], auth.getHash(), args[2], Long.parseLong(args[3]), Double.parseDouble(args[4]), Double.parseDouble(args[5]), Double.parseDouble(args[6]), Float.parseFloat(args[7]), Float.parseFloat(args[8]) , args[9], args[10], API.getPlayerRealName(args[0]));
                			break;
                		}
                		default: {
                			newAuth = new PlayerAuth(args[0], auth.getHash(), args[2], 0, 0.0, 0.0, 0.0, 0, 0, "world", "your@email.com", API.getPlayerRealName(args[0]));
                			break;
                		}
                	}
                    break;
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (args[0].equals(auth.getNickname())) {
                    switch (args.length) {
                    	...
                    	case 11: {
                    		newAuth = new PlayerAuth(args[0], args[1], auth.getIp(), auth.getLastLogin(), Double.parseDouble(args[4]), Double.parseDouble(args[5]), Double.parseDouble(args[6]), Double.parseDouble(args[7]), Double.parseDouble(args[8]), args[9], args[10], API.getPlayerRealName(args[0]));
                    		break;
                    	}
                    	default: {
                    		newAuth = new PlayerAuth(args[0], args[1], auth.getIp(), auth.getLastLogin(), 0.0, 0.0, 0.0,0,0, "world", "your@email.com", API.getPlayerRealName(args[0]));
                    		break;
                    	}
                    }
                    break;
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (args[0].equals(user)) {
                    switch (args.length) {
                        ...
                        case 11:
                        	return new PlayerAuth(args[0], args[1], args[2], Long.parseLong(args[3]), Double.parseDouble(args[4]), Double.parseDouble(args[5]), Double.parseDouble(args[6]), Double.parseDouble(args[7]), Double.parseDouble(args[8]), args[9], args[8], API.getPlayerRealName(args[0]));
                    }
                }
            }
        } catch (FileNotFoundException ex) {
	       ...
	       if (!isAuthAvailable(auth.getNickname())) {
	        ...
	        try {
	            ...
	            while ((line = br.readLine()) != null) {
	                String[] args = line.split(":");
	                if (args[0].equals(auth.getNickname())) {
	                    newAuth = new PlayerAuth(args[0], args[1], args[2], Long.parseLong(args[3]), Double.parseDouble(args[4]), Double.parseDouble(args[5]), Double.parseDouble(args[6]), Double.parseDouble(args[7]), Double.parseDouble(args[8]), args[9], auth.getEmail(), API.getPlayerRealName(args[0]));
	                    break;
	                }
	            }
	        } catch (FileNotFoundException ex) {
